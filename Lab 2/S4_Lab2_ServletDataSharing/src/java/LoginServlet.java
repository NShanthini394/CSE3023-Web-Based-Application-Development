...
public class LoginServlet extends HttpServlet {
    ...
    // 1. Retrieve the parameters from the HTML login form
    String user = request.getParameter("username"); 
    String pass = request.getParameter("password"); 

    // 2. Authentication Logic (Checking credentials)
    if (user != null && pass != null && user.equals("Ahmad") && pass.equals("4567")) {
        
        // Data Sharing: Save extra info into the 'request' object
        request.setAttribute("accountType", "Premium Student"); 
        request.setAttribute("email", "ahmad@siswa.edu.my"); 
        
        // Request Forwarding to AccountServlet
