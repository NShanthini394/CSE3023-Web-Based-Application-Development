<%-- 
    ...
    Created on : 2 Jun 2026, 2:57:43 pm
    Author     : shant
--%>
                    ...
                    <c:forEach var="employee" items="${listEmployee}">
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="delete?id=<c:out value='${employee.id}' />" onclick="return confirm('Are you sure you want to delete this employee?');">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
